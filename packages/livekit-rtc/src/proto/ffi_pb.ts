...
import type { PerformRpcCallback, PerformRpcRequest, PerformRpcResponse, RegisterRpcMethodRequest, RegisterRpcMethodResponse, RpcMethodInvocationEvent, RpcMethodInvocationResponseCallback, RpcMethodInvocationResponseRequest, RpcMethodInvocationResponseResponse, UnregisterRpcMethodRequest, UnregisterRpcMethodResponse } from "./rpc_pb";
...
export type FfiEvent = Message<"livekit.proto.FfiEvent"> & {
  ...
  message: {
    ...
    /**
     * @generated from field: livekit.proto.RpcMethodInvocationResponseCallback rpc_method_invocation_response = 25;
     */
