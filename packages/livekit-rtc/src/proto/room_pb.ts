...
// @generated by protoc-gen-es v1.4.2 with parameter "target=ts,import_extension=.js"
...
export class ConnectCallback_Result extends Message<ConnectCallback_Result> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "room", kind: "message", T: OwnedRoom },
    { no: 2, name: "local_participant", kind: "message", T: OwnedParticipant },
...
export class RoomInfo extends Message<RoomInfo> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 4, name: "lossy_dc_buffered_amount_low_threshold", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 5, name: "reliable_dc_buffered_amount_low_threshold", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
...
export class ParticipantDisconnected extends Message<ParticipantDisconnected> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 2, name: "disconnect_reason", kind: "enum", T: proto2.getEnumType(DisconnectReason) },
  ]);
...
export class E2eeStateChanged extends Message<E2eeStateChanged> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "state", kind: "enum", T: proto2.getEnumType(EncryptionState) },
  ]);
...
export class ConnectionQualityChanged extends Message<ConnectionQualityChanged> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "quality", kind: "enum", T: proto2.getEnumType(ConnectionQuality) },
  ]);
...
export class DataPacketReceived extends Message<DataPacketReceived> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "kind", kind: "enum", T: proto2.getEnumType(DataPacketKind) },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class ConnectionStateChanged extends Message<ConnectionStateChanged> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "state", kind: "enum", T: proto2.getEnumType(ConnectionState) },
  ]);
...
export class Disconnected extends Message<Disconnected> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "reason", kind: "enum", T: proto2.getEnumType(DisconnectReason) },
  ]);
...
export class DataStream_TextHeader extends Message<DataStream_TextHeader> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "operation_type", kind: "enum", T: proto2.getEnumType(DataStream_OperationType) },
...
export class DataStreamHeaderReceived extends Message<DataStreamHeaderReceived> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "header", kind: "message", T: DataStream_Header },
  ]);
...
export class DataStreamChunkReceived extends Message<DataStreamChunkReceived> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "chunk", kind: "message", T: DataStream_Chunk },
  ]);
...
export class DataStreamTrailerReceived extends Message<DataStreamTrailerReceived> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "trailer", kind: "message", T: DataStream_Trailer },
  ]);
...
export class SendStreamHeaderRequest extends Message<SendStreamHeaderRequest> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 2, name: "header", kind: "message", T: DataStream_Header },
    { no: 3, name: "destination_identities", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 4, name: "sender_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class SetDataChannelBufferedAmountLowThresholdRequest extends Message<SetDataChannelBufferedAmountLowThresholdRequest> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 3, name: "kind", kind: "enum", T: proto2.getEnumType(DataPacketKind) },
  ]);
...
export class ByteStreamOpened extends Message<ByteStreamOpened> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "reader", kind: "message", T: OwnedByteStreamReader },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class TextStreamOpened extends Message<TextStreamOpened> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "reader", kind: "message", T: OwnedTextStreamReader },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
