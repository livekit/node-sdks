 ...
 */
export type SendStreamHeaderCallback = Message<"livekit.proto.SendStreamHeaderCallback"> & {
  /**
   * @generated from field: required uint64 async_id = 1;
   */
  asyncId: bigint;
...
/**
 * Describes the message livekit.proto.SendStreamHeaderCallback.
 * Use `create(SendStreamHeaderCallbackSchema)` to create a new message.
 */
export const SendStreamHeaderCallbackSchema: GenMessage<SendStreamHeaderCallback> = /*@__PURE__*/
  messageDesc(file_room, 91);

/**
 * @generated from message livekit.proto.SendStreamChunkCallback
 */
export type SendStreamChunkCallback = Message<"livekit.proto.SendStreamChunkCallback"> & {
  /**
   * @generated from field: required uint64 async_id = 1;
   */
  asyncId: bigint;
...
/**
 * Describes the message livekit.proto.SendStreamChunkCallback.
 * Use `create(SendStreamChunkCallbackSchema)` to create a new message.
 */
export const SendStreamChunkCallbackSchema: GenMessage<SendStreamChunkCallback> = /*@__PURE__*/
  messageDesc(file_room, 92);
