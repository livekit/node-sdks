...
export class TrackPublishOptions extends Message<TrackPublishOptions> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 3, name: "video_codec", kind: "enum", T: proto2.getEnumType(VideoCodec), req: true },
    { no: 4, name: "dtx", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 5, name: "red", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 6, name: "simulcast", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 7, name: "source", kind: "enum", T: proto2.getEnumType(TrackSource), req: true },
    { no: 8, name: "stream", kind: "scalar", T: 9 /* ScalarType.STRING */, req: true },
  ]);
...
export class RoomOptions extends Message<RoomOptions> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "auto_subscribe", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 2, name: "adaptive_stream", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 3, name: "dynacast", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 4, name: "e2ee", kind: "message", T: E2eeOptions, opt: true },
    { no: 5, name: "rtc_config", kind: "message", T: RtcConfig, opt: true },
    { no: 6, name: "join_retries", kind: "scalar", T: 13 /* ScalarType.UINT32 */, req: true },
  ]);
