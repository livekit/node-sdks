...
export class RtcStats_Stream extends Message<RtcStats_Stream> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "rtc", kind: "message", T: RtcStatsData },
    { no: 2, name: "stream", kind: "message", T: StreamStats },
  ]);
...
export class OutboundRtpStreamStats extends Message<OutboundRtpStreamStats> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 21, name: "quality_limitation_reason", kind: "enum", T: proto2.getEnumType(QualityLimitationReason) },
    ...
    { no: 30, name: "scalability_mode", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class TransportStats extends Message<TransportStats> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 5, name: "ice_role", kind: "enum", T: proto2.getEnumType(IceRole) },
    ...
    { no: 14, name: "dtls_role", kind: "enum", T: proto2.getEnumType(DtlsRole) },
...
export class StreamStats extends Message<StreamStats> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "stream_identifier", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
