...
export class TrackPublicationInfo extends Message<TrackPublicationInfo> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 3, name: "kind", kind: "enum", T: proto2.getEnumType(TrackKind) },
    { no: 4, name: "source", kind: "enum", T: proto2.getEnumType(TrackSource) },
    ...
    { no: 11, name: "encryption_type", kind: "enum", T: proto2.getEnumType(EncryptionType) },
...
export class TrackInfo extends Message<TrackInfo> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "kind", kind: "enum", T: proto2.getEnumType(TrackKind) },
    { no: 4, name: "stream_state", kind: "enum", T: proto2.getEnumType(StreamState) },
...
export class SetTrackSubscriptionPermissionsRequest extends Message<SetTrackSubscriptionPermissionsRequest> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 2, name: "all_participants_allowed", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
