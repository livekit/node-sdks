...
export class NewVideoStreamRequest extends Message<NewVideoStreamRequest> {
   ...
   *
   * @generated from field: required bool normalize_stride = 4;
   */
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 4, name: "normalize_stride", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
  ]);
...
export class VideoStreamFromParticipantRequest extends Message<VideoStreamFromParticipantRequest> {
  ...
  /**
   * @generated from field: required bool normalize_stride = 5;
   */
  normalizeStride?: boolean;
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 5, name: "normalize_stride", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
  ]);
...
export class VideoConvertRequest extends Message<VideoConvertRequest> {
  /**
   * @generated from field: required bool flip_y = 1;
   */
  flipY?: boolean;
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "flip_y", kind: "scalar", T: 8 /* ScalarType.BOOL */, req: true },
    { no: 2, name: "buffer", kind: "message", T: VideoBufferInfo, req: true },
