...
import type { NewVideoStreamResponse, VideoRotation } from '@livekit/node-rtc-ffi-bindings';
import { NewVideoStreamRequest, VideoStreamType } from '@livekit/node-rtc-ffi-bindings';
